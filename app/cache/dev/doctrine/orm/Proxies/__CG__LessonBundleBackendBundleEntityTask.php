...
namespace Proxies\__CG__\Lesson\Bundle\BackendBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Task extends \Lesson\Bundle\BackendBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Lesson\\Bundle\\BackendBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'Lesson\\Bundle\\BackendBundle\\Entity\\Task' . "\0" . 'enabled', '' . "\0" . 'Lesson\\Bundle\\BackendBundle\\Entity\\Task' . "\0" . 'text');
        }
